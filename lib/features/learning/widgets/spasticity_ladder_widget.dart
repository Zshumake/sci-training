...
const List<_LadderStep> _ladderSteps = [
  ...
  _LadderStep(
    ...
    details: [
      ...
      '  Mechanism: Botulinum toxin Type A cleaves SNAP-25, preventing acetylcholine vesicle fusion at the neuromuscular junction. Type B cleaves synaptobrevin (VAMP).',
      '  Botox: 400 units MAX per session (FDA labeling for adult spasticity, total across all muscles upper + lower limb combined). Single muscle typical: 50-200 units. Off-label SCI doses up to 600 units. Onset 3-5 days, peak 2-6 weeks, duration 3-6 months',
      ...
      '  Initial trial bolus: 50 mcg intrathecal. Escalate to 75 mcg -> 100 mcg in 24-hour intervals if no response.',
      '  Positive response = >=2-point reduction in Modified Ashworth Scale at 4-8 hours post-bolus',
      '  Programmable pump implanted in abdomen, catheter into intrathecal space',
      '  Refill every 1-6 months; battery lasts 5-7 years',
      'ITB WITHDRAWAL (emergency): hyperthermia, hypertension, rebound spasticity, rhabdomyolysis, multi-organ failure',
      '  Rescue: Cyproheptadine 4-8 mg PO Q8H -- serotonin antagonist used as rescue for ITB withdrawal symptoms',
      '  Also restart/continue oral baclofen and consider benzodiazepines (diazepam, lorazepam)',
      '  Identify & fix pump/catheter failure; do NOT delay pharmacologic rescue',
    ],
  ),
  _LadderStep(
    number: 6,
