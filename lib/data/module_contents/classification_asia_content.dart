  ...
  tabs: [
    ...
    TopicTab(
      ...
      blocks: [
        ...
        ComparisonDiagramBlock(
          title: 'Complete vs Incomplete Injury',
          description: 'The presence or absence of sacral sparing determines completeness. This distinction is the most important prognostic factor in SCI classification.',
          left: ComparisonSide(
            title: 'Complete (AIS A)',
            features: [
              'NO sacral sparing at S4-S5',
              'No sensation (LT/PP) at S4-S5',
              'No deep anal pressure (DAP)',
              'No voluntary anal contraction (VAC)',
              'Only ~10-15% convert to incomplete',
              'Worst overall prognosis',
              'Zone of Partial Preservation applies',
              'Must wait for spinal shock resolution',
            ],
            themeColor: Color(0xFFDC2626),
          ),
          right: ComparisonSide(
            title: 'Incomplete (AIS B-E)',
            features: [
              'ANY sacral sparing present',
              'Sensation at S4-S5 OR DAP OR VAC',
              'Structural continuity of long tracts',
              'Better recovery prognosis',
              'AIS B: sensory only below NLI',
              'AIS C: motor preserved, <50% grade >=3',
              'AIS D: motor preserved, >=50% grade >=3',
        ...
        FlowchartBlock(
          title: 'AIS Grade Classification Decision Tree',
          description: 'Follow this algorithm to determine the AIS grade. Begin by assessing sacral sparing at S4-S5.',
          nodes: [
            FlowchartNode(id: 'start', text: 'Perform ISNCSCI Exam', type: FlowchartNodeType.start, color: Color(0xFF3B82F6)),
            FlowchartNode(id: 'sacral', text: 'Is there sacral sparing?\n(LT/PP at S4-S5, DAP, or VAC)', type: FlowchartNodeType.decision, color: Color(0xFF7C3AED)),
            FlowchartNode(id: 'aisA', text: 'AIS A\nComplete', type: FlowchartNodeType.outcome, color: Color(0xFFDC2626)),
            FlowchartNode(id: 'motor', text: 'Is there motor function\nbelow the NLI?\n(VAC or motor >3 levels\nbelow motor level)', type: FlowchartNodeType.decision, color: Color(0xFF7C3AED)),
            FlowchartNode(id: 'aisB', text: 'AIS B\nSensory Incomplete', type: FlowchartNodeType.outcome, color: Color(0xFFEA580C)),
            FlowchartNode(id: 'half', text: 'Are >=50% of key muscles\nbelow single NLI\ngrade >=3?', type: FlowchartNodeType.decision, color: Color(0xFF7C3AED)),
            FlowchartNode(id: 'aisC', text: 'AIS C\nMotor Incomplete', type: FlowchartNodeType.outcome, color: Color(0xFFEA580C)),
            FlowchartNode(id: 'aisD', text: 'AIS D\nMotor Incomplete', type: FlowchartNodeType.outcome, color: Color(0xFF059669)),
          ],
          edges: [
            FlowchartEdge(fromId: 'start', toId: 'sacral'),
            FlowchartEdge(fromId: 'sacral', toId: 'aisA', label: 'No'),
            FlowchartEdge(fromId: 'sacral', toId: 'motor', label: 'Yes'),
            FlowchartEdge(fromId: 'motor', toId: 'aisB', label: 'No'),
            FlowchartEdge(fromId: 'motor', toId: 'half', label: 'Yes'),
            FlowchartEdge(fromId: 'half', toId: 'aisC', label: 'No (<50%)'),
            FlowchartEdge(fromId: 'half', toId: 'aisD', label: 'Yes (>=50%)'),
          ],
        ),
        BulletCardBlock(
    ...
    TopicTab(
      ...
      blocks: [
        ...
        AnnotatedImageBlock(
          ...
          annotations: [
            AnnotationPoint(x: 0.50, y: 0.05, label: 'C2 — Occipital protuberance', description: 'At least 1 cm lateral to the midline at the occipital protuberance.', color: Color(0xFF3B82F6)),
            AnnotationPoint(x: 0.40, y: 0.10, label: 'C3 — Supraclavicular fossa', description: 'Above the clavicle, in the supraclavicular fossa.', color: Color(0xFF3B82F6)),
            AnnotationPoint(x: 0.30, y: 0.13, label: 'C4 — AC joint', description: 'Top of the acromioclavicular joint.', color: Color(0xFF3B82F6)),
            AnnotationPoint(x: 0.22, y: 0.24, label: 'C5 — Lateral elbow', description: 'Lateral side of antecubital fossa (elbow crease).', color: Color(0xFF3B82F6)),
            AnnotationPoint(x: 0.18, y: 0.33, label: 'C6 — Thumb', description: 'Dorsal surface of thumb, proximal phalanx. "Six-shooter."', color: Color(0xFF3B82F6)),
            AnnotationPoint(x: 0.17, y: 0.35, label: 'C7 — Middle finger', description: 'Dorsal surface of middle finger, proximal phalanx.', color: Color(0xFF3B82F6)),
            AnnotationPoint(x: 0.16, y: 0.37, label: 'C8 — Little finger', description: 'Dorsal surface of little finger, proximal phalanx.', color: Color(0xFF3B82F6)),
            AnnotationPoint(x: 0.28, y: 0.24, label: 'T1 — Medial elbow', description: 'Medial (ulnar) side of antecubital fossa.', color: Color(0xFF059669)),
            AnnotationPoint(x: 0.38, y: 0.17, label: 'T4 — Nipple', description: 'Nipple line (4th intercostal space at mid-clavicular line). T4 = Teat.', color: Color(0xFF059669)),
            AnnotationPoint(x: 0.45, y: 0.24, label: 'T6 — Xiphoid', description: 'Xiphoid process. T6 = siX. Critical autonomic level for AD.', color: Color(0xFF059669)),
            AnnotationPoint(x: 0.48, y: 0.32, label: 'T10 — Umbilicus', description: 'Umbilicus (belly button). T10 = belly-butTEN.', color: Color(0xFF059669)),
            AnnotationPoint(x: 0.45, y: 0.40, label: 'T12 — Inguinal ligament', description: 'Inguinal ligament at midpoint (groin crease).', color: Color(0xFF059669)),
            AnnotationPoint(x: 0.42, y: 0.55, label: 'L3 — Medial knee', description: 'Medial femoral condyle.', color: Color(0xFF7C3AED)),
            AnnotationPoint(x: 0.40, y: 0.72, label: 'L4 — Medial malleolus', description: 'Medial malleolus (medial ankle).', color: Color(0xFF7C3AED)),
            AnnotationPoint(x: 0.42, y: 0.82, label: 'L5 — Dorsal foot (3rd MTP)', description: 'Dorsum of foot at 3rd metatarsophalangeal joint.', color: Color(0xFF7C3AED)),
            AnnotationPoint(x: 0.52, y: 0.85, label: 'S1 — Lateral heel', description: 'Lateral heel. The "S" wraps around laterally.', color: Color(0xFF7C3AED)),
          ],
        ),
    ...
    TopicTab(
      ...
      blocks: [
        ...
        ComparisonDiagramBlock(
          title: 'Central Cord vs Brown-Sequard vs Anterior Cord',
          description: 'Each incomplete SCI syndrome has a distinctive pattern of motor and sensory loss based on which spinal cord region is damaged.',
          left: ComparisonSide(
            title: 'Central Cord',
            features: [
              'Most common incomplete syndrome (~50%)',
              'UE weakness > LE weakness',
              'Hands worst (distal > proximal)',
              'Hyperextension in elderly with stenosis',
              'Variable sensory loss (cape-like)',
              'Recovery: LE first, hands last',
